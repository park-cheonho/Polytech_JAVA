...
class Member2 {
      ...
      public Member2(String id, String pwd) {
         this.id = id;
         this.pwd = pwd;
...
public class ListMain2 {
	...
	public static void main(String[] args) {
        ...
        List<Member2> member = new ArrayList<>();
             
        member.add(new Member2("aaa", "1111"));
        member.add(new Member2("bbb", "2222"));
        member.add(new Member2("ccc", "3333"));
        member.add(new Member2("ddd", "4444"));
